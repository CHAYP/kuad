import csv
import re
from kuad18_2.student import Student
...
def load_applicant(data, students):
    for appl in data:
        if appl["id"] not in students:
            students[appl["id"]] = Student(
                appl["id"],
                "prefix",
                appl["fullname"],
                "last_name"
        ...
        students[appl["id"]].chooses.append(appl['n_1'])             
